...
<div id="waiting" ><h2 class="text-center col-sm-6 col-sm-offset-3">Die Mediatheken werden durchsucht. Das dauert ein bisschen.<br> Bitte warte einen Augenblick.<br><br><a class="hover" href="{{ URL::route('home') }}">Oder zurück zur Startseite</a></h2></div>
